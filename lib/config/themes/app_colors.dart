...
class AppColors {
  ...
  static const Color backgroundLight =
      Color(0xFFF8F8F8); // --background-color (light)
  static const Color backgroundDark =
      Color(0xff202020); // --background-color (dark mode)
  ...
  static const Color transparentColor =
      Color.fromRGBO(240, 166, 17, 0); // --transparent-color
  static const Color highlightColor =
      Color.fromRGBO(255, 170, 0, 0); // --highlight-color

  //* Shadow Color
  static const Color shadowEffect =
      Color.fromRGBO(0, 0, 0, 0.17); // For shadow or elevated elements
