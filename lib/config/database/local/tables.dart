...
''';
  ...
  static String get createInvoicesTable => '''
    CREATE TABLE ${TablesKeys.paymentsTable}(
      ...
      ${TablesKeys.invoiceCashNo} REAL  NOT NULL,
      ${TablesKeys.invoiceSubTotal} REAL  NOT NULL,
      ${TablesKeys.invoiceDiscountTotal} REAL  NOT NULL,
      ...
      ${TablesKeys.cashPayment} REAL  NOT NULL,
  ...
  static String get createInvoiceDtlTable => '''
    CREATE TABLE ${TablesKeys.invoiceDtlTable}(
      ...
      ${TablesKeys.discountP} REAL  NOT NULL,
      ${TablesKeys.taxP} REAL  NOT NULL,
      ${TablesKeys.taxV} REAL  NOT NULL,
      ${TablesKeys.grandTotal} REAL  NOT NULL,
