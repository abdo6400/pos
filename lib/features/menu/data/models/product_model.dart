...
class ProductModel extends Product {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        price2: json[ApiKeys.price2]?.toDouble(),
        price3: json[ApiKeys.price3]?.toDouble(),
        price4: json[ApiKeys.price4]?.toDouble(),
        ...
        rawMaterial: json[ApiKeys.rawMaterial],
        compositeMaterial: json[ApiKeys.compositeMaterial],
        compo: json[ApiKeys.compo],
        isMaximumQty: json[ApiKeys.isMaximumQty],
