...
import '../../../../core/utils/enums/internet_status_enums.dart';
...
import '../../../payment/presentation/bloc/pending_invoices/pending_invoices_bloc.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PendingInvoicesBloc, PendingInvoicesState>(
      builder: (context, state) {
        return BlocListener<InternetCubit, InternetStatus>(
          listener: (context, state) {
            if (state == InternetStatus.disconnected) {
              context.showMessageToast(
                  msg: StringEnums.network_error.name.tr());
            } else if (state == InternetStatus.connectedWifi ||
                state == InternetStatus.connectedMobile) {
              context
                  .read<PendingInvoicesBloc>()
                  .add(PendingInvoicesEventUploaded());
            }
          },
          child: BlocConsumer<PrintingCubit, PrintingStatusEnums>(
            listener: (context, state) {
